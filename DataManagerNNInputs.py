...
from NetworkInputsMethods import NetworkInputsMethods
...
class DataManagerNNInputs:
    ...
    def insert_new_inputs(self):
        network_methods = NetworkInputsMethods(self.db_manager)
        network_methods.insert_player_inputs()
