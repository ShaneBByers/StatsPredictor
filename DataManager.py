...
class DataManager:
    ...
    def get_soup_player_stats(self, games_dict):
        for game_id, game in games_dict.items():
            ...
            self.get_soup_player_stats_for_team(home_team, game_id)
            away_team = game.find('div', 'blk away-team')
            self.get_soup_player_stats_for_team(away_team, game_id)

    def get_soup_player_stats_for_team(self, team, game_id):
